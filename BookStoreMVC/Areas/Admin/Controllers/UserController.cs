...
public class UserController : Controller
{
    ...
    public IActionResult RoleManagment(string userId)
    {
        ...
        RoleVM.ApplicationUser.Role = _userManager
            .GetRolesAsync(_unitOfWork.ApplicationUser.GetFirstOrDefault(u => u.Id == userId))
            .GetAwaiter().GetResult().FirstOrDefault();
        return View(RoleVM);
    }

    [HttpPost]
    public IActionResult RoleManagment(RoleManagementViewModel RoleManagementViewModel)
    {
        string oldRole = _userManager
            .GetRolesAsync(_unitOfWork.ApplicationUser
                .GetFirstOrDefault(u => u.Id == RoleManagementViewModel.ApplicationUser.Id))
            .GetAwaiter().GetResult().FirstOrDefault();

        ApplicationUser applicationUser =
            _unitOfWork.ApplicationUser.GetFirstOrDefault(u => u.Id == RoleManagementViewModel.ApplicationUser.Id);
    ...
    {
        List<ApplicationUser> objUserList = _unitOfWork.ApplicationUser.GetAll(null, includeProperties: "Company").ToList();
